...
export default function SocialConnectionsDrawer({
  isOpen,
  onClose,
  userName,
}: SocialConnectionsDrawerProps) {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onClose}>
      <SheetContent
        side="bottom"
        className="sm:max-w-md sm:rounded-t-2xl sm:mx-auto"
      >
        <SheetHeader className="text-left">
          <SheetTitle className="text-2xl">Complete your profile</SheetTitle>
          <SheetDescription>
            Welcome, {userName}! Connect your social accounts to enhance your
            experience.
          </SheetDescription>
        </SheetHeader>
